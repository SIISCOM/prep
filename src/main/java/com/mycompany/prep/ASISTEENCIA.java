 ...
 * @author Jafet
 */
public class ASISTEENCIA extends javax.swing.JFrame {
...
JOptionPane.showMessageDialog(null, "Error: Usuario o contraseña incorrectos",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ASISTEENCIA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ASISTEENCIA().setVisible(true);
            }
        });
    }
